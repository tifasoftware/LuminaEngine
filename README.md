...
| FreeBSD / OpenBSD / NetBSD / Solaris / OpenIndiana / Haiku | ⚠️ Not officially tested. Submit bug reports if builds fail.                                                                                                                   |
| iOS / iPadOS                                               | 🔜 Feasibillity will be reevaulated. Players are encouraged to run the PSP version thru [PPSSPP](https://apps.apple.com/us/app/ppsspp-psp-emulator/id6496972903) instead.      |
| Android                                                    | 🚧 [Under Development](docs/android.md). Players are encouraged to run the PSP version thru [PPSSPP](https://play.google.com/store/apps/details?id=org.ppsspp.ppsspp) for now. |
| 3DS                                                        | ❌ Currently Broken (Crashes after boot screen)                                                                                                                                |
| GameCube                                                   | 🧪 [In R&D](docs/rwby.md)                                                                                                                                                      |
| PS2                                                        | 🧪 [In R&D](docs/rwby.md)                                                                                                                                                      |
| Dreamcast                                                  | 🚧 [Under Development](docs/rwby.md) (with support from [KallistiOS](https://github.com/KallistiOS/KallistiOS))                                                                |
| Xbox (OG)                                                  | 🧪 [In R&D](docs/rwby.md)                                                                                                                                                      |
| Wii                                                        | 🧪 In R&D (will be developed in conjunction with the GameCube port)                                                                                                            |
| Wii U                                                      | 🔜 Definitely Feasible                                                                                                                                                         |
| Nintendo Switch                                            | 🔜 Definitely Feasible                                                                                                                                                         |
| PS3                                                        | 🔜 Feasibillity will be researched.                                                                                                                                            |
