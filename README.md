...
| Android                                                    | 🧪 [In R&D](docs/android.md). Players are encouraged to run the PSP version thru [PPSSPP](https://play.google.com/store/apps/details?id=org.ppsspp.ppsspp) for now. |
| 3DS                                                        | ✅ Supported                                                                                                                                                         |
| GameCube                                                   | 🧪 [In R&D](docs/rwby.md)                                                                                                                                           |
| PS2                                                        | 🧪 [In R&D](docs/rwby.md)                                                                                                                                           |
| Dreamcast                                                  | 🚧 [Partially Working](docs/rwby.md) (still Under Development, with support from [KallistiOS](https://github.com/KallistiOS/KallistiOS))                            |
